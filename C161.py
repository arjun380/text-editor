...
exit_img = ImageTk.PhotoImage(Image.open("close.png"))

label_file_name = Label(root, text="File name")
label_file_name.place(relx=0.46,rely=0.03,anchor=CENTER)
...
save_button.place(relx=0.14,rely=0.03,anchor=CENTER)
